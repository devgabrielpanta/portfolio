export class AppTheme extends HTMLElement {
  ...
  cacheElements() {
    this.toggleButton = this.querySelector("#theme-toggle");
  ...
  onThemeChange(theme) {
    ...
    const [sun, moon] = this.querySelectorAll("svg");
    sun.setAttribute("opacity", theme === "light" ? 1 : 0.5);
    moon.setAttribute("opacity", theme === "dark" ? 1 : 0.5);
  }
