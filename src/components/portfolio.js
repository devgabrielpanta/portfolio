/**
<div class="flex flex-col justify-center max-h-full min-h-0 overflow-y-auto pr-4">
              <div class="collapse collapse-plus bg-base-100 border border-base-300">
                <input type="radio" name="my-accordion-3" checked="checked" />
                <div class="collapse-title font-semibold">Single Page Applications (SPA)</div>
                <div class="collapse-content text-sm">
                Desenvolvo aplicações robustas focadas na gestão eficiente de dados e otimização de processos corporativos. 
                Com projetos que vão desde sistemas de reservas em tempo real até plataformas SaaS como o "Plano Agenda Fechada", 
                crio interfaces fluídas e responsivas que transformam a experiência do usuário e elevam a produtividade operacional.
                </div>
              </div>
              <div class="collapse collapse-plus bg-base-100 border border-base-300">
                <input type="radio" name="my-accordion-3" />
                <div class="collapse-title font-semibold">Multi-Tenant Applications</div>
                <div class="collapse-content text-sm">
                Especialista em arquiteturas escaláveis, crio soluções que maximizam a eficiência e 
                eliminam redundâncias operacionais entre clientes. Através de sistemas inovadores, como geradores de 
                landing pages multi-tenant , permito que empresas gerenciem múltiplos inquilinos simultaneamente com uma 
                base de código unificada, segura e de alta performance.
                </div>
              </div>
              <div class="collapse collapse-plus bg-base-100 border border-base-300">
                <input type="radio" name="my-accordion-3" />
                <div class="collapse-title font-semibold">Headless CMS</div>
                <div class="collapse-content text-sm">
                Implemento soluções com Headless CMS (ex: Sanity.io), estruturando dados para separar o conteúdo do código. 
                Desenvolvo interfaces intuitivas e lógicas de conteúdo dinâmico que dão autonomia a equipes sem expertise técnica, 
                permitindo a gestão e atualização de informações de forma ágil e descomplicada em diversas plataformas.
                </div>
              </div>
              <div class="collapse collapse-plus bg-base-100 border border-base-300">
                <input type="radio" name="my-accordion-3" />
                <div class="collapse-title font-semibold">Website / WordPress</div>
                <div class="collapse-content text-sm">
                Desenvolvo websites de alta performance para PMEs e profissionais liberais, 
                utilizando tanto WordPress quanto tecnologias "vanilla" sob medida. 
                Com um portfólio diversificado no setor de serviços e hospitalidade (ex: UPsushi, DOCTA, Paris Clinics), 
                entrego presença digital sólida com foco em usabilidade e SEO para destacar sua marca.
                </div>
              </div>
            </div>
 */
